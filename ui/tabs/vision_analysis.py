...
class VisionModelClient:
    ...
    def _get_default_colors(self) -> Dict:
        ...
        semantic_colors = {
            ...
            "17": [255, 31, 0],      # Bases
            "18": [255, 224, 0],     # Steps
            "19": [255, 184, 6],     # Railing
            "20": [255, 5, 153],     # Signs
            "21": [173, 0, 255],     # Bins
            "22": [255, 184, 184],   # Towers
            "23": [255, 208, 0],     # Awnings
    ...
    def analyze_image(self, image_path: str, semantic_classes: List[str], 
                     ...
                     enable_median_blur: bool = True) -> Dict:
        """
        调用视觉模型API分析图片
        ...
        try:
            ...
            request_data = {
                ...
                "enable_median_blur": enable_median_blur
            }
            
            # 记录请求信息
            logger.info(f"Analyzing image with {len(semantic_classes)} classes, encoder: {encoder}")
            ...
            if response.status_code == 200:
                ...
                if result.get('status') == 'success':
                    ...
                    return {
                        ...
                        'median_blur_enabled': result.get('median_blur_enabled', enable_median_blur),
    ...
    def download_results_zip(self, image_path: str, semantic_classes: List[str],
                           ...
                           encoder: str = "vitb",
                           enable_hole_filling: bool = False,
                           enable_median_blur: bool = True) -> Tuple[Optional[bytes], Optional[str]]:
        """
        下载结果的ZIP文件
